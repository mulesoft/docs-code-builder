...
include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=component-long-description-acb]
//
...
To find every flow reference that calls a flow, right-click the flow in the canvas and select *Find References*. You can also press Shift+Alt+F12 (Windows and macOS).
