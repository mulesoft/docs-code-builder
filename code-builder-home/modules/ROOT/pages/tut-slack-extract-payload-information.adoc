...
+
image::add-transform-from-canvas-slack.png["A flow in the canvas UI with the *Add Component* button highlighted"]
...
+
image::add-set-payload-slack-case-canvas.png["A flow in the canvas UI with the *Add Component* button highlighted"]
