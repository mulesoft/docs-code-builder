...
Import a project JAR file or folder into a workspace.
...
Anypoint Code Builder generates the dependencies configured in the `pom.xml` for the project.
...
Open any valid project folder, including a project from Anypoint Studio (Studio) that's stored on your desktop. Alternatively, use the procedure in <<both-open-project-folder>> to open the project from your file directory instead of dragging and dropping the folder into Anypoint Code Builder.
