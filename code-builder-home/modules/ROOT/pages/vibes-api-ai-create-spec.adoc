...
* Ensure you have the *Mule Developer Generative AI User* and *Anypoint Code Builder Developer* permissions to use Mulesoft Vibes.
...
** Mock requests to the API directly.
...
If Auto-approve is disabled, Mulesoft Vibes requests your approval before making any file changes.
