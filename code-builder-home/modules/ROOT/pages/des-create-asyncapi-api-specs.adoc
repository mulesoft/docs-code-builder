...
. Create and design an AsyncAPI spec project in Anypoint Code Builder or import the spec from MuleSoft VCS:

* <<design-new-api-spec, Create and design an AsyncAPI spec project>>
* <<import-spec, Import an AsyncAPI spec from MuleSoft VCS>>
...
Import an AsyncAPI spec from MuleSoft VCS and use Git or another source-control management system compatible with VS Code to keep your project in sync. For more information, see xref:des-designing-api-specs.adoc#anypoint-scm[Source Control for API Design Projects].
