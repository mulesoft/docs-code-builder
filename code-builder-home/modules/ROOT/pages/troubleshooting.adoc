...
Unlike a local development environment, you don't have access to underlying server system folders, and you don't need to. All troubleshooting steps in this guide provide solutions you can perform directly from the IDE without requiring server access or file system permission changes.
...
*Cause:* In the Anypoint Code Builder cloud IDE, your work must be saved within your designated workspace folder to keep your projects secure and accessible. This error occurs when you attempt to create or save a project outside of that workspace, in a system-level folder such as `/home`, `/`, or `.config`.
