= Troubleshooting
:page-aliases: manage-web-ide-instance.adoc, troubleshoot-cloud-ide-disk.adoc
...
If you encounter an issue with an Anypoint Code Builder extension, capture the console logs from the developer tools and share them with the MuleSoft support team.
...
+
When the process is complete, Anypoint Code Builder shows this message:
+
----
...
To determine whether Anypoint Code Builder extensions are installed, check for the *Anypoint Extension Pack* in the *Extensions: Marketplace* panel:
...
* If the extension pack is _not_ installed, follow the installation steps at xref:start-acb.adoc#set-up-desktop[Set up Anypoint Code Builder].
