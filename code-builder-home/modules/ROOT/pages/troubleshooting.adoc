...
To determine whether Anypoint Code Builder extensions are installed, check for the *Anypoint Extension Pack* in the *Extensions: Marketplace* panel of the IDE:
