...
MuleSoft Vibes is a purpose-built assistant for the development lifecycle, available with Anypoint Code Builder. Use it to develop, manage, or maintain your applications. MuleSoft Vibes integrates with the xref:mulesoft-mcp-server::index.adoc[MuleSoft MCP Server] and supports many capabilities, such as:
