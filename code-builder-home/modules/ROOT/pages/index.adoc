...
//intro
Use Anypoint Code Builder for your API designs, implementations, and integration development. Work locally with Anypoint Code Builder on Microsoft Visual Studio Code (VS Code). Anypoint Code Builder supports the development lifecycle:
...
Get the Anypoint Code Builder experience through the Anypoint Extension Pack for Visual Studio Code. The extensions require installation to VS Code. See xref:start-acb.adoc[].
