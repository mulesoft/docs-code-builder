...
. If there's already a Transform Message component at the beginning of the flow, click it to open its properties. Otherwise, click *Add Component* (+) at the start of the flow and add *Core Processors > Components > Transform Message*.
...
+
If a second *Transform* already exists, skip this step.
. Click the *Transform Message* component to open its properties panel.
