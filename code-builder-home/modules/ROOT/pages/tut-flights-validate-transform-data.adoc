...
When you scaffold an API specification into an implementation project, APIKit automatically validates incoming requests against your API specification. This includes:
...
=== Open the Transform Message Component
...
==== Option B: Write the DataWeave Script Directly

Alternatively, you can write the complete DataWeave script in the *Script* view:
