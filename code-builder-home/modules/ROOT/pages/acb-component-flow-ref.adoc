...
If the referenced flow is in an imported Mule project dependency, it opens in a read-only canvas. You can inspect the flow and go to other flows in the dependency, but you can't modify the dependency flow or its XML.
