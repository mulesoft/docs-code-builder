...
The terminal window in the IDE also provides the path to the JAR, in the `/target` directory under your project folder. You can find the JAR file in the Explorer, under Java Projects:
