...
Before making changes to your GraphQL project, run the application locally to test the endpoints.
...
To deploy your Mule Application locally, run a debug session in Anypoint Code Builder:
