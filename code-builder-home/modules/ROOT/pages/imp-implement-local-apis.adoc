...
+
Both the API spec and the Mule project open, for example:
+
...
. Click the image:icon-tree-view.png["",15,15] (*Show canvas UI*) icon in the activity bar to open the canvas if it doesn't open automatically.
+
