...
+
When you publish your API fragment to Exchange from Anypoint Code Builder, it requests the name of the business group. See xref:access-management::business-groups.adoc[].
