...
When you install Anypoint Code Builder, the MuleSoft MCP Server tools are automatically registered in VS Code through the Language Model API. No additional configuration is required in VS Code.

To invoke the tools using natural language commands, you need GitHub Copilot.
