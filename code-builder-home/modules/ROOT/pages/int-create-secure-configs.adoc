...
To encrypt sensitive data, use the MuleSoft tool for your Java version.

* For Java 8 and 11, use https://docs.mulesoft.com/mule-runtime/4.4/_attachments/secure-properties-tool.jar[secure-properties-tool.jar^]
* For Java 17, use https://docs.mulesoft.com/mule-runtime/latest/_attachments/secure-properties-tool-j17.jar[secure-properties-tool-j17.jar^]
...
.. Download the Secure Properties Tool, an executable JAR file for encrypting properties:
+
* For Java 8 and 11, use https://docs.mulesoft.com/mule-runtime/4.4/_attachments/secure-properties-tool.jar[secure-properties-tool.jar^]
* For Java 17, use https://docs.mulesoft.com/mule-runtime/latest/_attachments/secure-properties-tool-j17.jar[secure-properties-tool-j17.jar^]
...
. _Before deploying to CloudHub or CloudHub 2.0_, ensure that the application deploys locally your IDE:
