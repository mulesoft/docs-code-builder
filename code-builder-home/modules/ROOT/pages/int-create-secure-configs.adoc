...
Add, edit, or delete a secure properties configuration from *Global Elements*. To add one, click *Add New* and select the secure properties type. To delete one, click the *More actions* (*...*) menu next to the element and select *Delete*.

To edit the secure properties configuration:

. Open *Project Properties* > *Global Elements*.
+
image:int-global-elements-panel-list.png["The Global Elements panel with a list of configurations including Secure Properties Config."]
+
