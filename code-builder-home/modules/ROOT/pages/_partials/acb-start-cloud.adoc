...
//
// tag::heading-before-you-begin[]
= Before You Begin with the Cloud IDE
// end::heading-before-you-begin[]
//
...
//
// tag::heading-launch-cloud[]
= Open the Cloud IDE from Anypoint Platform
// end::heading-launch-cloud[]
//
...
. Review the prerequisites in xref:anypoint-code-builder::start-acb-cloud.adoc#before-you-begin[Before You Begin with the Cloud IDE] so that you can use Anypoint Code Builder.
