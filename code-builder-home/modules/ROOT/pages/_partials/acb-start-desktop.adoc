...
Cursor, Trae, and Devin use the OpenVSX marketplace by default. Before you can search for and install Anypoint Extension Pack in these IDEs, configure the Visual Studio Marketplace as the gallery service URL.
...
. Replace the existing value with the following URL:
+
[source]
----
https://marketplace.visualstudio.com/_apis/public/gallery
----
. When Cursor prompts you to restart, click *Restart*.
...
. In the *Marketplace extension gallery service URL* field, replace the existing value with the following URL:
+
[source]
----
https://marketplace.visualstudio.com/_apis/public/gallery
