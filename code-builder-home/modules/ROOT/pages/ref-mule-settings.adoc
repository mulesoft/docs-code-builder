...
Enable FIPS compliance mode for your Mule applications. When enabled, the embedded JVM is configured to use Bouncy Castle FIPS (BCFIPS) modules for all cryptographic operations. Required for regulated PCE and GIA2H environments.
