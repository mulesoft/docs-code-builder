...
+
You can add API Autodiscovery from *Global Elements* instead of editing XML. See xref:int-global-config-elements.adoc#add-global-config[Add a Global Configuration].
