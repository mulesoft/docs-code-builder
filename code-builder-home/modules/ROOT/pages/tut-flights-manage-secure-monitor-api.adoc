...
Use xref:api-manager::api-instance-landing-page.adoc[API Manager] to manage, monitor, and secure your APIs. After deploying your application to CloudHub 2.0, register it with API Manager to apply governance policies, track usage, and control access.
