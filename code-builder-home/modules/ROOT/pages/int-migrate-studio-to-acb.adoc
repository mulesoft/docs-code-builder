...
| Open an existing Studio project folder in Anypoint Code Builder without packaging it, which is the fastest path when the project is already on your machine. See xref:int-import-mule-project.adoc[Importing Projects into Anypoint Code Builder].
|===
