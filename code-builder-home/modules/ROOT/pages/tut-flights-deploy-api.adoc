...
== Deploy Your Application to CloudHub 2.0 from Anypoint Code Builder
...
=== Step 1: Configure Deployment Settings and Deploy Your Project
...
=== Step 2: Monitor the Deployment Process
...
=== Step 3: Verify Your Deployed Application
