...
Design project names must be unique. To create a new design project with a name already used in Anypoint Code Builder, you must delete the existing project.
