...
To resolve this conflict, uninstall the Agentforce DX extension pack from VS Code and restart the IDE. Anypoint Code Builder already includes all Agent Script functionality, so no separate extension is required.
