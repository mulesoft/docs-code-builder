...
Deploy your agent network instance to a deployment target. You can deploy to a CloudHub 2.0 shared space or a CloudHub 2.0 private space. Agent network deployments are available on US Cloud and EU Cloud hosts only. For more information, see xref:hosting-home::index.adoc#control-plane-hosting-options[Control Plane Hosting Options].
