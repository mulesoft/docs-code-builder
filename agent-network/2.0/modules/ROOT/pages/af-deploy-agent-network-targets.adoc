...
Make sure you review the xref:af-get-started.adoc#before-you-begin[prerequisites for setting up agent network gateways and deployment targets].
...
* Undeploy the [project-name] project from staging.
...
. If you're not logged in already, log in to your Anypoint Platform account.
. In Anypoint Code Builder, choose one of the following:
  . In the Explorer view, right-click a project file and select *Undeploy Agent Network*.
  . From the Command Palette, run this command: *MuleSoft: Undeploy Agent Network*.
...
If you run operations within a CI/CD environment, use Anypoint CLI plugin to set up, create, build, publish, unpublish, deploy, and undeploy agent networks. For more information, see xref:af-build-agent-networks-in-a-ci-cd-environment.adoc[].
