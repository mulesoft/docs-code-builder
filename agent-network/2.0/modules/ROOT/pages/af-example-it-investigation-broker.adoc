...
image::af-it-broker-escalation-flow.png[Visual canvas showing the IT agent broker showing severity classification branching into escalation, investigation, and ask-for-more-info paths, each terminating in an echo response node.]
