...
For more information about versioning assets in agent network projects, see xref:af-publish-agent-network-assets.adoc#versioning-assets[Versioning Assets].
