...
Use natural language prompts in MuleSoft Vibes to create your project. For more information, see xref:anypoint-code-builder::vibes-api-ai-create-spec.adoc[].
...
Use a coding agent of your choice, like Claude or Cursor, with these publicly available MuleSoft skills on https://dev-portal.mulesoft.com/index.html?filter=skill[MuleSoft Developer Hub].

* https://dev-portal.mulesoft.com/skills/build-agent-broker-project.html[Build an agent broker project].
* https://dev-portal.mulesoft.com/skills/translate-agent-broker-old-to-new-project.html[Translate an agent network] 1.0 project to an agent network 2.0 project.
