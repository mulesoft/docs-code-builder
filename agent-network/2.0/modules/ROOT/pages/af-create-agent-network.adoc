...
== Convert a V1 Agent Network Project to a V2 Project
If you have an existing V1 agent network project, use natural language prompts in MuleSoft Vibes to convert it to a V2 project. V2 agent network projects use guided determinism to separate workflow steps requiring probabilistic LLM reasoning from those requiring deterministic control-flow logic. 
