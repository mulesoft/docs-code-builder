...
+
See xref:af-get-started.adoc#setup-space[Set Up the Target Space for Your Environment].
. Set up Omni Gateways for the space.
+
  * If using Anypoint Code Builder, see xref:af-get-started.adoc#setup-gateways[Set Up Agent Network Gateways for the Space].
