...
IMPORTANT: Agent networks use an automatic versioning system for Anypoint Exchange assets. If you make changes to your existing V1 agent network project assets and re-publish them, Exchange triggers a major semantic version upgrade (for example, 1.x.x to 2.x.x).
