...
MuleSoft Vibes can help you create your project. For more information, see xref:anypoint-code-builder::vibes-api-ai-create-spec.adoc[].
...
* xref:anypoint-code-builder::start-workspaces.adoc[]