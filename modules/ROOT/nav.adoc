...
//either here after renaming the file to prepend tut- or under the INTEGRATE section
...
//either here after renaming the file to prepend INT- or under the TUTORIALS section
