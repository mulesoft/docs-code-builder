...
* xref:setup.adoc[Set Up and Install]
...
** xref:business-group-support.adoc[Work With Business Groups]
...
//DELETED due to so much duplication in local-api-specification-tutorial.adoc
