...
** xref:start-acb.adoc#set-up-desktop[Setting Up the Desktop IDE]
** xref:start-acb.adoc#set-up-web[Launching the Cloud IDE]
...
*** xref:int-configure-components.adoc#add-components[Adding a Component to Your Project]
*** xref:int-work-with-code-snippets.adoc[]
*** xref:int-configure-dw-expressions.adoc[]
*** xref:int-configure-components.adoc#check-connection[Testing a Connection Configuration]
*** xref:int-configure-components.adoc#import-connectors-from-exchange[Importing a Connector from Exchange]
*** xref:int-configure-components.adoc#open-component-from-xml[Opening a Component from the XML Editor]
