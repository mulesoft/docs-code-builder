...
The MuleSoft MCP Server tools are available in Anypoint Code Builder and are also supported when you use the Anypoint Extension Pack in compatible IDEs such as VS Code, Cursor, and Windsurf.

For more information about these tools, see xref:mulesoft-mcp-server::reference-mcp-tools.adoc[MuleSoft MCP Server Tool Reference].
