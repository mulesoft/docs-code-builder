...
Add API fragments from Exchange for a data type and example. Then create your own examples for the specification, and add a custom message for a response. 

== Before You Begin

If you haven't started the American Flight API specification, complete this procedure before attempting to test:
