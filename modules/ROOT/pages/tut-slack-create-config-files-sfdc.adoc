...
+
image::contact-sync-integration-new-file.png["The resources directory highlighted in the explorer, with the *New File* menu option selected"]
...
+
image::sync-api-sfdc-test-connection.png["Code snippet with *Test Connection* button highlighted"]
+
...
+
image::add-logger-end-flow-canvas.png["The flow canvas with the *Add Flow* plus sign button highlighted"]
+
...
+
image::logger-breakpoint-sfdc.png["A line of code with the breakpoint highlighted"]
+
...
+
image::slack-app-debugger-logger-breakpoint.png["The *Variables* panel with the *Payload* variables highlighted"]
+
