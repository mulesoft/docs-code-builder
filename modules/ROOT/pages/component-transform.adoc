...
//
//Metadata info
//include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=metadata]
//
...
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-root]
//
...
//Component element and attribute descriptions
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-child1]
//
//Grandchild/Descendant Element (if needed, repeating as necessary): 
//Component element and attribute descriptions
//include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-descendant1]
//
