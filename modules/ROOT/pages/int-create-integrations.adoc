...
+
You can select from any of the supported versions. The IDE automatically downloads versions that append the message *(downloads upon project creation)* when you create the project.
