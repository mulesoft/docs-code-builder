...
+
//TODO: UPDATE THIS OUT-OF-DATE IMAGE
...
--
+
The file's canvas UI provides the same options for building your project file that  appear when you create an integration project. 
