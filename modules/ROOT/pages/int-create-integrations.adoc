...
.. In the canvas, click image:icon-plus.png["",15,15] (*Add component*).
...
+
If the connector is not available locally, click image:icon-search-exchange.png["",15,15] (*Search in Exchange*) toggle:
+
