...
. Select the `http:listener-config` snippet.
+
...
To import a connector from Exchange and add it to your code:
...
----
. Select *Connector*.
. Search for the connector name to import, such as "MQ".
For example:
+
...
https://anypoint.mulesoft.com/exchange/[Exchange^] and
...
This file contains global configurations and/or flow structures.
