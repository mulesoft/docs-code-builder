...
Add components to your project from the canvas UI. You can configure many connectors and components. 
...
The following example illustrates basic configuration options from canvas UI and configuration XML. The example assumes you are beginning from an empty integration project.
