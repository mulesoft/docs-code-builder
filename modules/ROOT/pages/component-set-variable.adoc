...
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=accessing-variables]
// 
//EXAMPLES SECTION
...
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-ex4]
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-ex5]
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-ex6]
//
