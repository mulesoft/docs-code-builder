...
:page-aliases: acb-component-async.adoc
:version: 4.x
...
//Component element and attribute descriptions
//include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tag=component-xml-attributes-child1]
//
//Grandchild/Descendant Element (if needed, repeating as necessary): 
//Component element and attribute descriptions
//include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tag=component-xml-attributes-descendant1]
//
include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tag=async-vs-subflow]
// 
//EXAMPLES SECTION
