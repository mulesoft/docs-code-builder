...
If you don't have a connection established with a Salesforce organization, you can select a Salesforce trial organization when you enable Einstein for Anypoint Code Builder, however, it's best to choose your own private Salesforce organization to avoid service disruption. If you don't have a Salesforce organization with Einstein enabled, contact your Salesforce Account Executive (AE).
...
+
Einstein is now enabled for all the users in your Anypoint Platform organization. You can remove permission to access Einstein from individual users in access management. 
