...
//
//Metadata info
//include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=metadata]
//
...
include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=component-xml-root]
//
// component SNIPPET XML, if available:
//include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=component-snippet-xml]
//

//Child Element (if needed, repeating as necessary): 
//Component element and attribute descriptions
include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=component-xml-child1]
//
//Grandchild/Descendant Element (if needed, repeating as necessary): 
//Component element and attribute descriptions
//include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=component-xml-descendant1]
//
