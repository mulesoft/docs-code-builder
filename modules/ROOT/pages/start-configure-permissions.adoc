...
To grant the *Anypoint Code Builder Developer* permission to an individual user:

. In Anypoint Platform, navigate to *Access Management*.
+
For the Anypoint Platform URL, see <<before-you-begin>>.

. Follow the steps in xref:access-management::users.adoc#grant-user-permissions[Grant Permissions to Users] to assign the *Anypoint Code Builder Developer* permission to the user.
...
To grant the *Anypoint Code Builder Developer* permission to a team:
...
** *Anypoint Code Builder Developer* to make the IDE available to the team.
