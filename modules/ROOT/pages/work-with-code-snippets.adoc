...
<2> XML for the minimally configured Choice component. The same XML is added to the configuration XML when you navigating to *Core Processors* > *Flow Control* > *Choice* from the canvas. The icon for minimally configured XML is a three-dimensional square.
