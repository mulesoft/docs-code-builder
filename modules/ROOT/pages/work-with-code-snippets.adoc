...
+
Like built-in snippets, user snippets are also available from the auto-complete menu in the configuration XML. In the auto-complete menu, find the name for the snippet that you provided in `mule-xml.json` and add the snippet to the XML. 