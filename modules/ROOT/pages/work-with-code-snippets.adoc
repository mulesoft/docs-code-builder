...
<1> XML for the built-in Choice snippet, identified as `flow:choice` in the auto-complete list.
<2> XML for the minimally configured Choice component. The same XML is added to the configuration XML when you navigating to *Core Processors* > *Flow Control* > *Choice* from the canvas.
