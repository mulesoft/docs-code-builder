...
// TODO: Rewrite to convert this title into an action. For example, "Previewing Results in a DataWeave Transformation"
...
// TODO: The above include has a warning that should be rewritten to something like: "To use this feature in you project, you must add the following dependency to your project pom.xml file:" to avoid mentioning "web IDE".
...
. In Anypoint Code Builder, select *Develop an Integration*.
. Name your project _normalize-dates_ and select *Browse*.
+
image::integration-1.png["Project name and browse highlighted"]
. Select your home directory.
. Select *Create Project*:
+
image::create-project-dw-example.png["Create Project highlighted"]
...
--
+
Anypoint Code Builder warns you about the payload not being resolved:
+
