= Previewing Results in a DataWeave Transformation
...
. Specify your home directory for the location.
+
// Is this true? 
In the desktop IDE: the path is set to your default project location.
...
--
. Within the `[CDATA[` code, add the following DataWeave code:
+
[source,dataweave]
--
%dw 2.0
