...
. Click image:icon-plus.png["",15,15] (*Add component*) after the *On New Case* Salesforce component:
+
...
. Click image:icon-plus.png["",15,15] (*Add component*) after the Transform Message component:
+
