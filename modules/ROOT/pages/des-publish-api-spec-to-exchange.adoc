...
+
If you have uncommitted changes in the Source Control panel, push them before publishing to Exchange. For more information about source control, see xref:start-scm.adoc[].
