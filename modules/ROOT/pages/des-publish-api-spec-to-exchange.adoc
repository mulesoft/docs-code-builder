...
You can select the API, navigate through its summary, and see all the endpoints you defined in the previous tasks. You can also generate documentation for REST APIs without documentation on the asset details page in Exchange. For more information, see https://docs.mulesoft.com/exchange/generating-documentation-with-ai[Generating API Documentation with Einstein Generative AI^].
