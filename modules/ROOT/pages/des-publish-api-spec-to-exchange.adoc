...
You can select the API, navigate through its summary, and see all the endpoints you defined in the previous tasks. You can also review AI-generated doc or make changes right in the asset details page in Exchange. For more information, see https://docs.mulesoft.com/exchange/generating-documentation-with-ai[Generating Documentation with AI^].
