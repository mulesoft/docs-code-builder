...
//
//Caching process
include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=caching-process]
//Caching strategy
include::partial$mule-components/4.4/component-{component-filename}.adoc[tag=caching-strategy]
//
