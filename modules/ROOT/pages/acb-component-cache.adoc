...
//for studio only:
//include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tags=component-xml-ex3,component-xml-ex3-studio]
//for acb only:
include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tags=component-xml-ex3,component-xml-ex3-acb]
//
