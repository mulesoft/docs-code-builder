= Connecting to a Database from the Integration
...
Complete xref:tut-integrate-am-flights.adoc[].
...
--
. Proceed to xref:tut-integrate-use-dataweave-to-transform-data.adoc[]. 
+
