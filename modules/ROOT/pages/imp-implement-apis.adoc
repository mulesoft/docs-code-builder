...
//TODO: ADD LINK TO INFO ON MULE & JDK VERSIONS?
| *Mule runtime* |Mule runtime version to use for your project. Mule downloads can take a few minutes.
| *JDK* |JDK version to use for Mule. 
|===
...
** Adds the Mule and JDK versions to the `pom.xml`, for example:
+
