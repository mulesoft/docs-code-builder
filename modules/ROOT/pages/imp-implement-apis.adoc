...
After you scaffold your API into your interface, examine the scaffolded flows and error handlers for your interface in the UI canvas and configuration XML.
