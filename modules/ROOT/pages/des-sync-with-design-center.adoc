...
If you want to synchronize your API design projects in Anypoint Code Builder with Design Center, you can opt to use the built-in integrated source control management (SCM) in Anypoint Code Builder to upload your API specifications or fragment to Design Center.
