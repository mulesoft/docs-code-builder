...
This walkthrough enables you to create an API from scratch that implements a GraphQL API that you uploaded to Exchange.
...
== Upload the GraphQL API to Exchange

You can only implement a GraphQL that exists in Exchange. Additionally, you can only add a GraphQL API by manually uploading it to Exchange:
