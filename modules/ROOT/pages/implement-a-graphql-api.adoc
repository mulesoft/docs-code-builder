...
. In Anypoint Code Builder, open the Command Palette (`ctrl/cmd + shift + P`) and type _MuleSoft: Implement an API Specification_.
+
. Select the command.
...
Start typing _books_ and hit `enter` to get a list of possible results. Click *Add Asset* next to the *books-api* asset.
+
image::select-books-graphql-api.png[]
+
. Select *Create Project*.

// TODO: cc: Desktop IDE prompted to save a `.code-workspace` file here. Is this correct behavior?
