...
Anypoint API Governance is a component of Anypoint Platform that enables you to apply governance rules to your APIs as part of the API lifecycle. For more information, see xref:api-governance::index.adoc[].
...
//+
//TODO_SHOW_ME_HOW
. Open the *Governance Rulesets* panel in your project. For example:
+

. Hover over the panel, and click image:anypoint-code-builder::icon-gov-ruleset-add.png["",15,15] (*Add Governance Rulesets...*) .
