...
Check API specifications in your Anypoint Code Builder API design projects for conformance with rules in governance rulesets, and fix issues in your specifications that do not conform to the rules.
...
Add governance rulesets to your API design project in Anypoint Code Builder. 
