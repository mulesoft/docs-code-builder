...
If any of your rules return errors or warnings that you need to address, fix the specification to comply with the rules. Then re-run the rule to ensure that the fix is effective.  
