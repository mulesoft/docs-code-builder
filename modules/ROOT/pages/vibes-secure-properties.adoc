...
To set up secure properties, send this message to MuleSoft Vibes:
...
To encrypt a specific value, send this message to MuleSoft Vibes:
...
To add a new encrypted property, send this message to MuleSoft Vibes:
...
To create environment-specific secure properties files, send this message to MuleSoft Vibes:
...
To change your encryption key and re-encrypt all values, send this message to MuleSoft Vibes:
