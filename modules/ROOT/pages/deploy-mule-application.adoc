...
Anypoint Code Builder deploys applications to a non-production environment in CloudHub. 
...
// TODO: from CrisP: Adding necessary step. If no application is open, the "MuleSoft: Deploy to Cloudhub" command is not displayed. Is this the expected behavior? 
. Open the application to deploy.
...
. Select your application from the list applications. The domain name for your application is +american-ws-anypoint-code-builder.eu-s1.cloudhub.io+.
