...
NOTE: Anypoint Code Builder can only deploy applications to CloudHub 1.0.
...
// TODO: Adding necessary step. If no application is open, the "MuleSoft: Deploy to Cloudhub" command is not displayed. Is this the expected behavior? 
