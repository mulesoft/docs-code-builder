...
+
image::int-create-integration-scratch.png["Develop an Integration form. with Empty Project selected"]

.. Under *Project Name*, provide the name *mock-dw-library.
...
+
//Info about downloads and versioning:
include::anypoint-code-builder::partial$acb-runtime-java.adoc[tags="runtime-version-note"]
