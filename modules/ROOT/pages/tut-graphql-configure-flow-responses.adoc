...
--
+
Anypoint Code Builder returns your configured JSON response in the terminal:
+
[source,JSON]
--
{
...
After testing the `bookById` endpoint, you can use Set Payload to add mock responses for testing the remaining flows:
