...
| *API Specification Language* | *RAML 1.0* or *OAS 3.0* +
...
|===
. Select *Create Project* to generate the American Flights API project file: `american-flights-api`.
+
The file name and extension are based on the name you provide for the project and the API specification language you use.
+
...
. In the `american-flights-api` file, paste this code for the `/flights` endpoint and `get` method:
+
...
. Replace your content with this specification:
+
[tabs]
====
OAS Example::
