...
== Example Avro Schema AsyncAPI Spec Fragment

If you created an Avro Schema fragment project, you can replace the initial API fragment with following example code:
