...
Alternatively, <<create-add-fragment-directly, create and add a fragment directly in your project>> without publishing it to Exchange.
...
+
You can also see the fragment in the Explorer view under the Project Dependencies folder, for example:
+
