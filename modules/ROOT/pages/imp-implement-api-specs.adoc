= Implementing OAS, RAML, and GraphQL API Specifications
...
Anypoint Code Builder scaffolds your API and creates the necessary flows for each endpoint on your API specification endpoints.
...
See xref:apikit::apikit-graphql-api-mapping.adoc[] for more information about data fetchers.
...
. Type the name of your API specification and press Enter.
