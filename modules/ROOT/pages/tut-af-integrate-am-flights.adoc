...
From the canvas UI::
+
Click the *Listener* operation to open the configuration UI, and set the HTTP Listener attributes to the following values:
+
...
From the canvas UI::
+
Click the Set Payload component to open the configuration UI, and set the attributes to the following values:
+
