...
.. In the canvas UI, after your *Flow* component, select the `plus` icon:
+
...
* In the cloud IDE, click the image:icon-menu.png["cloud IDE menu",18,18] (menu) icon before selecting *View* > *Terminal*
+
[source, terminal]
----
*******************************************************************************
...
. Submit a curl command from the terminal to trigger the flow: 
+
[source,URI]
----
