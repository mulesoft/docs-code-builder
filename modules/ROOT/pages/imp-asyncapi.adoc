...
* <<ex-flows-scaffolded>>
+
The scaffolder generates a set of flows for the order processing API from `publish` operations defined in the AsyncAPI specification example. The example includes a 
...
The notification flow examples are triggered by the 
