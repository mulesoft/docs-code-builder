...
The scaffolder generates a `flow.xml` file from the specification. The scaffolder generates the following file from the <<ex-asyncapi-spec, AsyncAPI specification example>>:
