...
//use note about Java 8 and 11
include::partial$java8-eoss-banner.adoc[tags="notice-banner"]

IMPORTANT: Standard support for Java 8 ends in March 2025 for Mule 4.8 Edge and August 2025 for 4.6 LTS. Plan your upgrade path for apps that are running on Java 8 accordingly.
