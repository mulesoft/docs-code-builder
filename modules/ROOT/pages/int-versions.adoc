...
Projects open instantly using these bundled runtimes to avoid downloading runtimes before you can start designing. Download a specific runtime version if you want to run or debug your application with an exact version that isn't available locally.
