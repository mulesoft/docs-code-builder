...
When you create a project, Anypoint Code Builder stores all it in your home directory by default. You can create another folder or folders for your projects in the IDE.
...
. Open the Terminal window, first typing Ctrl and then a backtick (`).
