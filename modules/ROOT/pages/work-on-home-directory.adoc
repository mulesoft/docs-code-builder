...
== Create Project Folders in the Desktop IDE

To create a local folder for your projects from the Desktop IDE:

. Open the command palette (`ctrl/cmd + shift + P`) and type the following command to open a local file menu:
+
[source,command]
----
 _File: Open Folder..._.
...
+
image::file-open-folder-command.png[]
. Use your local file menu to create new folder. 

== Create Folders from the Desktop or Web IDE
