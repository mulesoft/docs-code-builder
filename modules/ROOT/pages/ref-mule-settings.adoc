...
Set the time in milliseconds to wait before displaying auto-completion options. This setting defaults to 500 milliseconds. See also <<setting-auto-complete>>.