...
==  Mule > Editor > Suggestions
//TODO: CHECK "Suggestions" vs. "Auto-completion"
//==  Mule > Editor > Auto-completion

Enable auto-completion suggestions in the API design editor in Anypoint Code Builder. This setting prevents the need to press Ctrl+Space to activate a list of suggestions and is enabled by default. See also <<setting-auto-complete-debouncer>>.

[[setting-auto-complete-debouncer]]
==  Mule > Editor > Suggestions > Debouncer
//TODO: CHECK "Suggestions" vs. "Auto-completion"
//==  Mule > Editor > Auto-completion > Debouncer

Set the time in milliseconds to wait before displaying auto-completion options. This setting defaults to 2000 milliseconds. See also <<setting-auto-complete>>.