...
Avoid setting a long delay. If you begin to work on something else in the IDE during the delay period, the focus of the IDE returns to the auto-completion menu in your spec when the delay period expires.
