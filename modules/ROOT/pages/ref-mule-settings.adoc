...
* To open the auto-completion menu, place your cursor in the editor and click Enter. On a line with existing content, tab to the location that you intend to edit. The menu opens when the trigger delay expires.
* To close the auto-suggestion menu, click Escape. 
