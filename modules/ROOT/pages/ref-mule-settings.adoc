...
Used for the Anypoint Code Builder design experience with the MCP Connector (beta). These are the available values.

* `-Dmule.http.service.implementation=NETTY`: The MCP Connector is enabled. 
* blank: The MCP Connector is disabled or not installed.
