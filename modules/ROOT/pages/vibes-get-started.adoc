...
Anypoint Code Builder uses an MCP connector to maintain compatibility with MCP integrations to keep tool-driven workflows reliable across supported scenarios.
