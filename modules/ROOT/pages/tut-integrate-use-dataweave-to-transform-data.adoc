...
+
For guidance, see xref:tut-integrate-am-flights.adoc#run[Run Your App in Debug Mode].
. After the app deploys successfully, use a REST Client or browser to trigger a response.
+
For guidance, see xref:tut-integrate-am-flights.adoc#test[Test Your App].
...
. Stop your app. 
+
For guidance, see xref:tut-integrate-am-flights.adoc#stop[Stop Your App].
