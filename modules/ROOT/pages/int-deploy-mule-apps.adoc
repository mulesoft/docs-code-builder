...
[[ki-W-15907750]]
. If you are deploying an application that uses Mule 4.6 or Mule 4.7, you must manually update the `runtime` property in `deploy.json` with a valid runtime and Java version. 
+
For instructions, see xref:release-notes::code-builder/acb-release-notes.adoc#ch-runtime-versions[Known Issue W-15907750] in the Release Notes.
