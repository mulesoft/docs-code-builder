...
To deploy to another supported environment, create a deployable JAR file.
For information, see xref:int-export-mule-project.adoc#deployable[Export to a Deployable JAR File].
...
If you need to configure properties at deployment time, for example, 
...
* xref:int-export-mule-project.adoc#deployable[Export to a Deployable JAR File]