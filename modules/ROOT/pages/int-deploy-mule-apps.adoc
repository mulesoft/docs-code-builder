...
The `deploy.json` file contains version-specific properties for deployments of Mule applications to CloudHub and CloudHub 2.0 from Anypoint Code Builder.

* <<deployment-cloudhub>>
* <<deployment-cloudhub2>>

For more information, see xref:cloudhub::index.adoc[] and xref:cloudhub-2::index.adoc[].
