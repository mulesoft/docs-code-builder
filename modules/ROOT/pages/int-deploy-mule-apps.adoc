...
To deploy to CloudHub you must configure a `deploy.json` file in your `src/main/resources` directory.
...
+
image::select-deployment-environment.png["Select the environment"]
+
