...
=== Required Permissions for MuleSoft Dev Agent

MuleSoft Dev Agent always uses the permissions of the logged-in Anypoint Platform user.  
...
If you want to configure MuleSoft Dev Agent with a different set of permissions, you must:  
