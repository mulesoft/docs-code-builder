...
* The Salesforce organization you are connected to for Einstein requests has Einstein Generative AI enabled. See https://help.salesforce.com/s/articleView?id=sf.generative_ai_enable.htm&type=5[Set Up Einstein Generative AI] for more information.
