...
:page-aliases: ui-tut-design.adoc, design-api-specification.adoc, design-api-specification-from-scratch.adoc
...
To build, test, synchronize, and publish the specification:
...
+
For more guidance, see xref:des-create-api-specs.adoc.adoc#design-new-api-spec[Create a New API Specification Project].
