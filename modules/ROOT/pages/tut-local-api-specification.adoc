...
. In the activity bar of the desktop IDE, click image:icon-ms-logo.png["",20,20] (*Anypoint Code Builder*) to open Anypoint Code Builder.
...
+
.. Click image:icon-implement-api.png["",15,15] (*Implement this local API*) in the activity bar:
+
