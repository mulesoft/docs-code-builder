...
. In Anypoint Code Builder, open the *Source Control* view of the IDE:

* From the desktop IDE, select *View* > *Source Control*.
* From the cloud IDE, click the image:icon-menu.png["cloud IDE menu",18,18] (menu) icon, and select *View* > *Source Control*.
...
. In the *Source Control* view, stage your changes by mousing over the *Changes* heading to display the *+* (plus) icon and then clicking the icon:
+
