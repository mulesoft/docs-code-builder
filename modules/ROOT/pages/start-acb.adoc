...
[%collapsible]
====
To save your work, you must either deploy your Mule projects to CloudHub, or commit them to a source control management (SCM) system.
...
//TODO (FEB): COULD THIS ISSUE STILL OCCUR IF THEY ARE CONFIGURED TO SYNC WITH DC?
