...
==== 
Do not install the individual Anypoint Code Builder extensions that are also available separately from Anypoint Extension Pack in VS Studio Marketplace.
====
...
. If you work in the EU region and your Anypoint Platform account resides in the EU Cloud, change the *Mule: Control Plane* setting to *EU Cloud*. 
+
