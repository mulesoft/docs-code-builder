...
In the desktop IDE, you can change your Anypoint Platform control plane to the US or EU Cloud. US Cloud is the default. Anypoint Platform instances do not share user accounts, projects, or other data. For more information, see xref:index.adoc#cloud-hosts[US and UE Cloud Hosts]. 
