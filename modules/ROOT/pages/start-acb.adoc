...
. If you are a customer on the EU control plane with an Anypoint Platform account running in the EU Cloud, change the *Mule: Control Plane* setting to *EU Cloud*. 
+
