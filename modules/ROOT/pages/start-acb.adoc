...
. If you work in the EU region and your Anypoint Platform account resides in the EU Cloud, change the *Mule: Control Plane* setting to *EU Cloud*. If you work in the EU region and your Anypoint Platform account resides in the EU Cloud, change the *Mule: Control Plane* setting to *EU Cloud* and add a system variable. 
+
...
If you are in the EU Cloud, set the environment variable for your system first:
...
To ensure you have access to all of the Anypoint Code Builder features, you must add a system environment variable:
...
. Set the dekstop IDE to EU in Anypoint Code Builder.
