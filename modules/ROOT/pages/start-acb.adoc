...
. If you are an EU cutomer with an Anypoint Platform account running in the EU Cloud, change the *Mule: Control Plane* setting to *EU Cloud*, and add a system variable to point to the EU environment. 
+
