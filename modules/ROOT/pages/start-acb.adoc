...
* From the Anypoint Code Builder panel, click the *Open ACB Settings* (gear).
* From the activity bar, click the *Manage* (gear), select *Settings*, and search for `mule` in the *Settings* tab.
