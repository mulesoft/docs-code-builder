...
. To use Anypoint Platform in the EU Cloud from your IDE, set the environment variable for your system:
...
.. Click on path and verify that it says `ANYPOINT_ENV=prod-eu`.
//Duke, This step I'm not sure about. Click on what path?
. Set the desktop IDE to EU in Anypoint Code Builder.

If you are setting up your desktop IDE, resume the procedure in <<change-clouds]>>.
