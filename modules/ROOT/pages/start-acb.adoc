...
To install the Anypoint Service Pack: 
...
+
Your cloud IDE environment is associated with your user account, which other users cannot access. The environment has a unique URL that only you can access.
