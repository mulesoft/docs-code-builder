...
Use the Mocking Service in the API Console to check the request and responses that you configured for American Flights API in xref:tut-af-design-api-add-request-response-details.adoc[].
