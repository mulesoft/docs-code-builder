...
If your project doesn't contain any tests, you can:

* <<import-test, Import a project that contains MUnit tests>>
* <<create-tests, Create tests or test suites in an existing project>>
...
Configure MUnit tests and test suites using the canvas or the XML editor. 
...
Create an MUnit test in a new or existing test suite. Use the canvas or the XML Editor to start an MUnit test. For guidance with your test configuration, refer to the <<prereqs, MUnit documentation>> described in the prerequisites.
