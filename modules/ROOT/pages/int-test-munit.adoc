...
. Click or mouse over the suite or test name, and click image:anypoint-code-builder::icon-munit-go-to-test-gray.png["",18,18] (*Go to test*) or highlighted image:anypoint-code-builder::icon-munit-go-to-test.png["",18,18] (*Go to test*) to open the XML file that contains the test.
+
