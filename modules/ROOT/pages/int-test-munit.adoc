...
----
.. In the `launch.json` file, add a comma after the first object in the array, and append the MUnit launch configuration by pressing Ctrl+Space in `launch.json` to open the auto-complete menu and selecting *MUnit Debug Launch*. For example:
+
