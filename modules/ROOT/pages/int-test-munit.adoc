...
* To rerun the test from the Testing Results panel, open the panel, click the failing test in the test logs, and click the image:anypoint-code-builder::icon-munit-run-test.png["",18,18] (Run test) icon from the test logs. 
