...
This procedure requires the Enterprise Edition of Mule runtime engine (Mule). For licensing information, see xref:mule-runtime::installing-an-enterprise-license.doc[Install an Enterprise License].
.
