...
You can use rules to enforce organizational conventions, ensure consistent error handling, and maintain coding standards across your workspace.
...
Rulesets allow you to define and apply organizational conventions across your development workflows using natural language.
