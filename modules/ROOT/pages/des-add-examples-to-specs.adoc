...
// tut-design-api-add-request-response-details
//LOGO (web, desktop, or both)
include::partial$acb-ide-logos.adoc[tags="both-ides"]

Add API fragments from Exchange for a data type and examples to your API specification.
Then create your own examples for the specification, and add a custom message for a response. 
...
. In Anypoint Code Builder, open your API specification. For example, `american-flights-api.raml`.
...
+
When the process is complete, check for the asset, such as `AmericanFlightDataType.raml`, in your project's `exchange_modules/` directory. For example: 
+
----
