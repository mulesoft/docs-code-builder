...
. In Anypoint Code Builder, open your API specification. For example, `my-project-api.raml`.
...
. Open your `project-name.yml` file from the project directory in Explorer.
...
value:
    ...
    plane:
      ...
      totalSeats: 150
--
. In your `project-name.raml` file, include the file you just created.
+
