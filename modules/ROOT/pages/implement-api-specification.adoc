...
Import your American Flights API specification from Anypoint Exchange. Scaffold the specification into the American Flights project that you are developing, and add the logic to implement an endpoint.
...
== Import Your American Flights API Specification from Exchange

. In Anypoint Code Builder, open your integration application, `american-ws-anypoint-code-builder`.
+
For reference, see xref:create-basic-integration.adoc[].
