...
Anypoint Code Builder identifies differences you make to files since you last synchronized changes with the main branch in Design Center.

When you change your API specification, the Source Control icon in the Activity Bar displays the number of changes to the API project. 
...
+
//TODO duke: hamburger menu present
