...
. xref:tut-api-publish-api-spec-to-exchange.adoc[]

After creating, testing, and synchronizing the American Flights API specification, you can xref:implement-api-specification.adoc[implement] the specification within an xref:develop-integration.adoc[integration].
