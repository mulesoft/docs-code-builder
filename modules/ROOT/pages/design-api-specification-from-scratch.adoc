...
Start creating the American Flights API specification from the *Quick Actions* menu in Anypoint Code Builder. 
...
+
images::acb-api-console.png["A specification with get and post methods"]
+
