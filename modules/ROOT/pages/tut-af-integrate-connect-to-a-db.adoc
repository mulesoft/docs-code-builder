...
. From the canvas UI, click the image:icon-plus.png["",15,15] (*Add component*) icon below the HTTP Listener component.
...
From the canvas UI::
+
Click the *Select* connector to open the configuration UI.
+
In the configuration UI, set the Select attributes to the following values:
+
image::tut-int-db-connector-ui.png["Configure the Listener operation through the configuration UI."]
+
[calloutlist]
