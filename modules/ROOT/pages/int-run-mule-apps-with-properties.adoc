...
Reference environment variables using the `${env:VARIABLE_NAME}` syntax. The configuration above references `ENCRYPTION_KEY` and `MULE_ENV` from your system environment.
