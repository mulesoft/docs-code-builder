...
When an integration that you are developing builds successfully, the application deploys _locally_, within your development environment, whether on your desktop or to the web-based host for your Anypoint Code Builder applications. It is common to configure an HTTP Listener to trigger the execution of a deployed application through a URL. The URLs to use for the desktop and web IDEs differ:
