...
When an integration that you are developing builds successfully, the application deploys _locally_ within your development environment, whether on your desktop or the web-based host for your Anypoint Code Builder applications. 
...
* In the web IDE, your local development environment is hosted remotely, so you must configure a URL to a proxy for your application's external host. 
+
