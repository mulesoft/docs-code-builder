...
It is common to configure an HTTP Listener to trigger the execution of a deployed application through a URL. The URLs to use for the desktop and web IDEs differ for deployments to your development environment:
...
* In the web IDE, your local development environment is hosted remotely, so you must configure a URL to a proxy for your application's host. 
+
