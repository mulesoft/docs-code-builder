...
Anypoint Code Builder is built from the Anypoint Extension Pack extensions to Visual Studio Code. Both the desktop and web IDEs for Anypoint Code Builder share these extensions. 

* <<set-up-desktop>>: For the desktop IDE, you must load the extension pack to your local Visual Studio Code IDE. 
* <<set-up-web>>: For the web IDE, you must acquire the permission to log in to Anypoint Platform to open Anypoint Code Builder. 
...
. Open the desktop IDE in Visual Studio Code by clicking the MuleSoft icon in the activity bar.
...
To gain access to Anypoint Code Builder from Anypoint Platform:
...
* https://eu.anypoint.mulesoft.com/eu.anypoint.mulesoft.com[^eu.anypoint.mulesoft.com] for the EU-compliant host

You must use the URI for the host that contains your user account, which is associated with a specific business organization. The accounts and business organizations are not shared across the hosts. 
