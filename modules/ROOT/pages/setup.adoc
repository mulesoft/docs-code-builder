...
:beta: For the Beta release, install the pre-release version of the installer.
:warning: Anypoint Extension Pack provides all the extensions for Anypoint Code Builder. Do not install the individual extensions from the pack that are also available separately from the marketplace.
...
. Open VS Code. 
. Find *Anypoint Extension Pack* from the desktop IDE or from https://marketplace.visualstudio.com/[Visual Studio Marketplace^].
+
{warning}
