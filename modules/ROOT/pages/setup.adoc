...
:beta: For the Beta release, install the pre-release version of the extension pack.
:warning: Do not install the individual Anypoint Code Builder extensions that are also available separately from the marketplace.
