...
For more information, see https://code.visualstudio.com/docs/sourcecontrol/overview[Using Git source control in VS Code^] in the VS Code documentation.  To learn about Git branching strategies and how to work effectively with multiple team members, see the https://git-scm.com/book[Git documentation^].
