...
When parsing an API specification, the desktop IDE depends on your computer's resources. To avoid issues, ensure your computer has the following minimum resources available:
