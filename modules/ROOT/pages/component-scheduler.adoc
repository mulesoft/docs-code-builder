...
//Grandchild/Descendant Element (if needed, repeating as necessary): 
//Component element and attribute descriptions
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-attributes-descendant2]
//
...
include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=cron-expressions]
//
