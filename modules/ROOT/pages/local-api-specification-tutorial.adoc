...
To avoid potential issues from limitations of multi-root workspaces when creating an API specification, start with a new VS Code window and parent folder for your API specification project:
