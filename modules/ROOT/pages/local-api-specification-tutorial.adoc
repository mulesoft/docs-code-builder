...
Scaffold an API specification into an interface within your IDE, and synchronize changes to the specification with the interface without first publishing to Anypoint Exchange. The interface is a configuration XML file automatically created during the scaffolding process.
