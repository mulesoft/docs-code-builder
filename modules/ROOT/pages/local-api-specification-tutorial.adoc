...
Open a multi-root workspace from the `.code-workspace` file for the projects, such as `Retrieve Users API.code-workspace`. 
...
----
. Navigate to and double-click the `.code-workspace` file for your projects.
+
The projects open in the Explorer view, and the name of the multi-root-workspace appends a *(WORKSPACE)* identifier. For example:
+
images::tut-api-multiroot-workspace.png["A multi-root workspace in the Explorer"]
