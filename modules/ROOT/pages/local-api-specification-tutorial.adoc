...
:page-aliases: implement-a-local-api-guide.adoc, implement-local-api-specification.adoc, tut-local-iterative-design-implement.adoc
...
+
IMPORTANT: Do not save this file within your API specification project folder. Proceed to the next step, instead.
...
* In the cloud IDE, navigate to file menu > *View* > *Source Control*.
