...
TIP: You can close a multi-root workspace with the command `Workspaces: Close Workspace`. After closing the workspace, you can reopen your synchronized project from the workspace that you create <<implement-local, when implementing the API>>.
