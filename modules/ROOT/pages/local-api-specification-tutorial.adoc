...
To avoid potential issues from limitations of multi-root workspaces when creating an API specification, start with a new VS Code window, and create a parent folder for the specification:
