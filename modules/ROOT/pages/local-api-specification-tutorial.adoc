...
Iterative API design and implementation within the IDE takes place in a multi-root workspace in VS Code. The IDE permits only one set of iterative design and implementation projects per multi-root workspace. 
