...
A local project for a specification or implementation resides in your Anypoint Code Builder IDE, whether in your desktop IDE or in the web IDE associated with your user account in Anypoint Platform. Synchronizing your local API specification with a local implementation project in your IDE requires a multi-root workspace in Visual Studio Code.
