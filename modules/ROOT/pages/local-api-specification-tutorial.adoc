...
// TODO: Should this title be more consistent with other titles? Something like: "Iteratively Designing and Implementing an API Specification"?
...
// TODO: Should we define "Local API"? What does this mean in the context of the Web IDE? Also, will customers know what a "multi-root workspace is"? Should this be defined? Should it be "multi-version workspace"?
...
// TODO: the Desktop IDE asks to choose a project name here.
...
// TODO: Does the customer need to know about this file extension? The Desktop IDE UI didn't mention this file extension anywhere.
+
[IMPORTANT]
--
