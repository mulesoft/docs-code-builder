...
For more information about trust settings in the IDE, see https://code.visualstudio.com/docs/editor/workspace-trust#_trusting-a-workspace[Trusting a workspace^] in the VS Code documentation. 
