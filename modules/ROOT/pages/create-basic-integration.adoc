...
. Press Return to move to a new line and `tab` to add an indentation.
...
--
. Open the Terminal window Ctrl (Mac) followed by a backtick (`), and verify that the deployment was successful.
+
[source]
--
*******************************************************************************************************
