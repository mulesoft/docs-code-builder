...
// TO-DO: We can delete this image. The following image shows the important content and it is valid for the web IDE and VSCode plugin.
...
// TO-DO: We should get in touch with UI responsible to learn what phrase will be finally used "Getting started" or "Quick Actions". Be consistent in the use of capital letter in every word.
+
