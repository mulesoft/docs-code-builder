...
+
If you do not receive this response, make sure your application is DEPLOYED, review your XML configuration, and <<check-connection, recheck your HTTP Listener connection>>. 
