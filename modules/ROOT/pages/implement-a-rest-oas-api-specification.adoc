...
.. *Show filters*: Enables you to filter search results. See xref:to-find-info.adoc#filter-search-results[Filter Search Results on Exchange] for more information.
