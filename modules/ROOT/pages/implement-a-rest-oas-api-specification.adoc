...
Start typing the name of the API specification that you want to implement and press Return to get a list of possible results. Click *Add asset* to select the API specification that you want:
+
