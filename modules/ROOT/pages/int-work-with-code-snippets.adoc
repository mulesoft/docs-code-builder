...
. On the canvas, click image:icon-plus.png["",15,15] (*Add component*) where you want to add the snippet:
+
...
. In the canvas, click image:icon-plus.png["",15,15] (*Add component*) where you want to add the snippet:
+
image::main-tutorial-add-first-http-listener.png["Mule application canvas"]
...
. Select *Snippets* > *User Snippets*. 
+
. Click image:icon-snippet-plus.png["",15,15] (*Create user snippet*).
+
...
.. Reusable code
. Save the snippet and click image:icon-snippet-refresh.png["",15,15] (*Refresh snippet list*).
