...
If a component references another flow (for example, via a Flow Reference connector), you can quickly access the target flow in the canvas. To open the referenced flow, press Ctrl+Alt+g (Windows) or Cmd+Option+g (macOS), or:
...
In the MUnit canvas, you can use Flow Reference components to invoke or simulate execution of other flows. To help you trace and validate the logic, you can navigate to the referenced flow from within the test. To open the referenced flow, press Ctrl+Alt+g (Windows) or Cmd+Option+g (macOS), or:
