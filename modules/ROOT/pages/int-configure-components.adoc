...
. Select the component. To copy multiple components, press and hold the Ctrl key (Windows) or Cmd key (macOS) and select the components.
. Right-click a component and click *Copy Component*. Or press Ctrl+c (Windows) or Cmd+c (macOS) to copy the components.
