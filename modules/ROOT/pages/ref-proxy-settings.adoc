...
Execute network-dependent functions in Anypoint Code Builder, such as publishing to Exchange, logging into Anypoint Platform, and running or debugging applications, you must configure your proxy settings in Visual Studio Code (VS Code). 
