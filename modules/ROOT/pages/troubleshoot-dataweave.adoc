...
Either provide the intended value or use xref:int-configure-dw-expressions.adoc#quick-fix-variable[Quick Fix] to convert the character sequence into a DataWeave variable. For more information, see xref:dataweave::dataweave-variables.adoc[].
...
image::dw-issue-invalid-input.png[]
