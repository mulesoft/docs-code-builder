...
+
[arabic]
.. *Continue*: Proceed to the next breakpoint, if present, and pause execution or the execution of the application. Otherwise, continue to the end of the application. Key command: F5
