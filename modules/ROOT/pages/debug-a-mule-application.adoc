...
Anypoint Code Builder does not have a mechanism for hot redeployments. 

To redeploy a running application that you are debugging, open the Command Palette by pressing Ctrl+Shift+p (Windows) or Cmd+Shift+p (Mac), and provide the following command:
+
[source,command]
----
