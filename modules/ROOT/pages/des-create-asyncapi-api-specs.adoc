...
Use Anypoint Code Builder to create, import, and test AsyncAPI specs before publishing to Anypoint Exchange:

. Create an AsyncAPI spec project in Anypoint Code Builder from the IDE or by importing the spec from Design Center:

* <<design-new-api-spec, Create an AsyncAPI spec project from the IDE>>
...
[[design-new-api-spec]]
== Create a New AsyncAPI Specification Project

To create an AsyncAPI spec project in Anypoint Code Builder:
