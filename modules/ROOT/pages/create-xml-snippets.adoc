...
Define user snippets for Transform (`<ee:transform/>`) and other components in the `mule-xml.json` file. Snippets are helpful for getting started component configurations that are not built in and available across your Mule projects. You can configure snippets for connector operations, Core processors, and other processors in the XML configuration file for your Mule applications.  
