...
Create user snippets for your integration to use before you create the integration. Snippets are reusable code patterns that you can add to your Mule application flows and subflows. In addition to providing built-in snippets, the IDE enables you to configure your own user snippets. 
