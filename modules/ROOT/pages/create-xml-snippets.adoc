...
Before creating the integration, create user snippets for it to use. Snippets are reusable code patterns in configuration files for your Mule application flows. In addition to providing built-in snippets, the IDE enables you to configure your own user snippets. 
...
--
. Add your snippet code to the file. For example: 
+
[source,xml,linenums]
--
{
...
--
. To find your user snippets in the IDE:
...
This list is specific to your IDE instance. 
