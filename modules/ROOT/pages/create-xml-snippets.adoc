...
Start from xref:design-api-specification-from-scratch.adoc[], and complete the remaining tasks: adding examples, testing with the mocking service, synchronizing with Design Center, and publishing to Exchange.
