...
Before starting an integration project for the American Flights example, define user snippets. Snippets are reusable code patterns that you can insert from the IDE into the configuration XML of Mule applications. 
...
* Complete American Flights API specification:
+
Start from xref:design-api-specification-from-scratch.adoc[], and complete the remaining tasks for adding examples, testing with the mocking service, synchronizing with Design Center, and publishing to Exchange.
