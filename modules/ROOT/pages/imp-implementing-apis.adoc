...
Use Anypoint Code Builder to implement an API by importing the API spec from 
Anypoint Exchange and scaffolding it into an interface for your integration project (Mule app).
