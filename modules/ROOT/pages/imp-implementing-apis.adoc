...
Use Anypoint Code Builder to start an API implementation project by importing the API spec and scaffolding it into an interface to implement and integrate within a Mule app.

Anypoint Code Builder supports automatic scaffolding of OAS, RAML, and GraphQL APIs,
