...
Use Anypoint Code Builder to start an API implementation project by importing and scaffolding an API spec into an interface that you implement and integrate within a Mule app.
