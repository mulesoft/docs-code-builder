...
When an issue occurs, the first step is to check for problems and issues. The *Problems* tab lists warnings and error messages. The *Output* panel provides build details and access to logs that can help you understand underlying issues. 
