...
Disabled components appear greyed out in the canvas and are ignored at runtime. In the XML editor, the block is wrapped in an XML comment.

Once the issue is resolved, you can re-enable the component or use Bulk Delete to remove disabled items.
