...
:page-aliases: ai-creating-topic-enabled-api-spec.adoc

Design and configure your API specs for topics and agents, which makes them available for use by developers in API Catalog in Salesforce.
