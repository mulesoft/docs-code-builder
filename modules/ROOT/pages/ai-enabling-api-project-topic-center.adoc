...
Topic Center automatically makes your API operations available as agent actions and topics. Agents perform common tasks autonomously, such as updating records, searching and summarizing data, and securely taking action in various systems. Agents are reusable across any set of topics and can contain multiple topics. 
...
+
You can configure agent topics at a later time if you don't do it now.
