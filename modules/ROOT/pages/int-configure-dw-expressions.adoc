...
* Review provided sample data is valid. See <<sample-data>> for supported data formats (MIME types) for sample data.
...
. After the mapping is complete, review the mapping to make changes if needed, or apply the mapping to your project.
