...
* The Org Admin must enable the AI features in Anypoint Platform
* Enable Einstein in ACB settings
//TODO: Add a link to the Einstein generative AI documentation: https://docs.mulesoft.com/anypoint-code-builder/ai-enabling-api-project-topic-center. 
* Create sample input and output data
//TODO: Add a link to the sample data documentation (If there's no examples in current docs, the PRD has some examples and also examples available at: https://docs.google.com/document/d/14iUy8qkh5xPeUXy_p4IaX_Zlsuy-1k50cNeod2eWLls/edit?usp=sharing).
