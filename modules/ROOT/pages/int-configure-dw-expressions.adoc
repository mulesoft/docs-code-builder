...
You can provide sample data for Mule variables, such as `payload` and for a valid sequence of characters. 
...
. Hover over the value for which you want to provide sample data. For example:
+
TODO: ADD IMAGE
...
TODO: ADD IMAGE
+
Now hovering over the value displays the type and structure of your sample data. 
+
TODO: ADD IMAGE 
. 
