...
+
image::mule-runtimes-settings.png["The default directory locations for the Mule Runtime Engine and its versions"]
...
image::troubleshoot-download-java-notification.png[]
