...
The warning *No Mule runtime found. To perform this action, you must have Mule runtime configured.* occurs if Mule isn't configured properly when you open Anypoint Code Builder. 
