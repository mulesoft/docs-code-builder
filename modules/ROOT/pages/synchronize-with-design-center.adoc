...
// VALE recommends using Sync instead of Synchronize
...
When you change your API specification, the Source Control icon in the Activity Bar shows you an overview of how many changes you currently have. Selecting the icon shows you the details of your current changes: *CHANGES*, and *STAGED CHANGES*:
