...
--
. Click image:icon-plus.png["",15,15] (*Add component*) after the *Not Escalated* route of the Choice router:
+
image::add-slack-action-example-canvas.png[]
. Click image:icon-search-exchange.png["",15,15] (*Search in Exchange*), type `Slack`, and select *Slack Connector*:
+
