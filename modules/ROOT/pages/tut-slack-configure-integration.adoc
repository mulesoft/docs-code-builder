...
* xref:tut-slack-create-escalation-slack-api.adoc[]
* xref:tut-slack-create-config-files-sfdc.adoc[] 
* Configuring your Salesforce integration
* Creating variables for your payload +
See xref:tut-slack-extract-payload-information.adoc[].
* Configuring a Choice router and adding an Email connector to your flow +
See xref:atut-slack-add-condition-to-your-flow.adoc[].
