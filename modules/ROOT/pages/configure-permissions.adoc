...
+
image::select-username-access-management.png[“User name highlighted in the *Organization Users* tab.”]
. On the *Anypoint Code Builder* tab, select *Select Access* > *Anypoint Code Builder Developer*.
+
image::access-management-select-access.png[“*Anypoint Code Builder* tab, *Select Access* menu, and *Anypoint Code Builder Developer* option”]
