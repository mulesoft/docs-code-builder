...
. Click the plus sign icon to add the permission to this user:
+
...
. Select the business groups where you want to add your selected permissions and click *Next*.
...
* xref:https://docs.mulesoft.com/access-management/configure-teams[Configure Teams] in Access Management
