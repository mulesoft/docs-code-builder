...
* Verify that you accepted Anypoint Code Builder beta terms and conditions. If you cannot log in, get in contact with your organization administrator. Your organization administrator must accept Anypoint Code Builder beta terms and conditions+
...
. Click the user name of the user to which you assign permissions:
+
