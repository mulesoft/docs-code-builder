...
Log in to Anypoint Platform, either from the Anypoint Code Builder IDE when you work from the web or from your desktop IDE for Anypoint Code Builder. 

Anypoint Code Builder features that require a connection to Anypoint Platform produce an error if you don't log in to Anypoint Platform.
