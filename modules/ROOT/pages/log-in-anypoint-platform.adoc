...
Some Anypoint Code Builder features require a connection to Anypoint Platform. Log in to Anypoint Platform, either from the Anypoint Code Builder IDE when you work from the web or from your desktop IDE for Anypoint Code Builder. 
