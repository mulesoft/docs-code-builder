...
Log in to Anypoint Platform when you work from the web or from your desktop IDE for Anypoint Code Builder. This practice avoids errors that occur during processes that require a connection, and it prevents requests Anypoint Code Builder from asking you to log in while you work.
