...
[[default-versions]]
//TODO: VERIFY JDK or Java EVERYWHERE!
== Select Default Mule and Java Versions

//TODO: VERIFY JDK, or Java
...
//TODO: VERIFY *And JDK* -- could change *And Java*
. Find *Mule › Application: Default Mule Runtime And JDK* in the open tab.
...
//TODO: VERIFY JDK or Java EVERYWHERE!
[[project-versions-from-properties]]
=== Select Mule and Java Versions from the Project Properties Tab
...
. From *Mule runtime & JDK* in the *Project Properties* side bar, select the versions to use in this project.
+
image::int-project-properties.png["Setting Mule and Java versions in Project Properties tab"]

//TODO: VERIFY JDK or Java EVERYWHERE!
[[project-versions-from-palette]]
=== Select Mule and Java Versions from the Command Palette

//open project local attribute:
. {open-project}
//step: open command palette:
include::partial$acb-reusable-steps.adoc[tags="open-command-palette"]
//step: open project properties tab from command palette
...
* <<connector-version-from-palette>>
...
[[connector-version-from-properties]]
=== Select Connector Versions from the Project Properties Tab
...
//TODO: P3: ADD SCREENSHOT AND EXAMPLES
. Select connector versions. 

[[connector-version-from-palette]]
=== Select Connector Versions from the Command Palette
