...
TODO: convert to real steps: When you click *Set Versions* only (see next scenario for *Set Version*)
...
Get the *Set Version* page, no longer supported notification
