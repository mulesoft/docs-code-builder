...
In some cases, the ref element needs to point to an asset that's defined in a different business group. For this, the *ref#namespace* attribute can be used to reference the asset's groupId.
