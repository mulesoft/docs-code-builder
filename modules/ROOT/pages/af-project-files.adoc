...
Assets, IT Stock, HR, Payroll, and Badges agents are what we call leaf agents. These aren't brokers but preexisting agents whose purpose isn't to coordinate work, but to act.
