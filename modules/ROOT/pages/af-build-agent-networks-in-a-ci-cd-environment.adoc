...
After you create a target space, and haven't already done so, set up the ingress and egress gateways for deployment. See xref:af-get-started.adoc#setup-gateways[].
