...
For installation, package updates, and release details, see link:https://www.npmjs.com/package/mulesoft-anypoint-cli-agent-fabric-plugin[mulesoft-anypoint-cli-agent-fabric-plugin on npm].

== Before You Begin

Make sure you meet the prerequisites for this task. For prerequisites, see xref:af-get-started.adoc#before-you-begin[].
...
After you create a target space, set up the ingress and egress gateways for deployment if you have not already done so. See xref:af-get-started.adoc#setup-gateways[Set Up Agent Network Gateways for the Private Space or Deployment Target].
