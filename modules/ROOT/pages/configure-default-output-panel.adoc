...
Configuring the output panel in Anypoint Code Builder to view extension logs in *Mule DX Server* is helpful for understanding the status of Anypoint Code Builder activity.  
