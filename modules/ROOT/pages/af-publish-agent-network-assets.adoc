...
MuleSoft Dev Agent can help you publish your agent network assets. Just click the agent icon image:af-acb-dev-agent-icon.png["MuleSoft Dev Agent icon"] in the Anypoint Code Builder activity bar and tell the agent that you want to publish your agent network. MuleSoft Dev Agent does the rest.  For more information about MuleSoft Dev Agent, see link:https://docs.mulesoft.com/anypoint-code-builder/api-ai-create-spec[Creating API Specs with AI].
