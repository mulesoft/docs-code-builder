...
MuleSoft Dev Agent can help you publish your agent network assets. Click the agent icon image:af-acb-dev-agent-icon.png["",15,15] in the Anypoint Code Builder activity bar and tell the agent that you want to publish your agent network. MuleSoft Dev Agent does the rest.  For more information about MuleSoft Dev Agent, see xref:api-ai-create-spec.adoc[].
