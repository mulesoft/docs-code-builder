...
+
See xref:anypoint-code-builder::af-get-started.adoc#set-up-space[Set Up the Private or Target Space for Your Environment].
. Set up Ingress and egress Flex Gateways for the private or target space.

  * If using Anypoint Code Builder, see xref:anypoint-code-builder::af-get-started.adoc#set-up-gateways[Set Up Agent Network Gateways for the Private or Target Space].
