...
. Set up Ingress and egress Flex Gateways for the private or target space.
  ...
  * If using Anypoint Code Builder, see xref:anypoint-code-builder::af-get-started.adoc#set-up-gateways[].
  * If using the Anypoint CLI, see the xref:anypoint-cli::agent-fabric.adoc#agent-network-setup-gateways[].
