...
It can include assets defined locally within the project and assets previously published to Anypoint Exchange, either by the your organization or third parties.
+
