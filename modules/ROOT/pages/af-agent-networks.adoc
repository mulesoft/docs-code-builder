...
The following diagram shows an agent network with agents and MCP servers, traffic through Flex Gateway, governed by API Manager, and observed in Monitoring and Visualizer.
