...
* Open the Anypoint Code Builder panel from the IDE. The panel provides links to the most frequent actions. See an example of the panel in xref:start-discover-ui.adoc[].
+
[source,command]
----
