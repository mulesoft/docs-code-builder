...
To delete a design project for your API spec or fragment from Anypoint Code Builder, delete the entire project folder. If you imported the API spec from MuleSoft VCS or if your project was created with earlier versions of Anypoint Code Builder (prior to February 2024) that required storage of the spec in the MuleSoft VCS, you can delete the project from MuleSoft VCS by accessing Design Center. Deletion is necessary if you want to reuse the project name for a new design project in Anypoint Code Builder. 
...
Design project names must be unique. To create a new design project with the same name in Anypoint Code Builder, you must delete the existing project from the IDE. If your design project is stored in MuleSoft VCS, you can also delete it from MuleSoft VCS by accessing Design Center.
