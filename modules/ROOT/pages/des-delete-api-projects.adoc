...
To delete a design project for your API spec or fragment from Anypoint Code Builder, delete the entire project folder from Anypoint Code Builder. If you imported the API spec from Design Center or if your project was created with versions of Anypoint Code Builder (prior to February 2024) that required storage of the spec in the Anypoint SCM, also delete the spec from Design Center.
