...
//TODO (FEB): DETERMINE IF WE WANT TO KEEP THIS SECTION HERE OR AT ALL
If you store your API design projects in Design Center and want to reuse a project name, you must first delete the project from Design Center.
