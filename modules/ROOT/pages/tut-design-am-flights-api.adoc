...
After creating, testing, synchronizing, and publishing the American Flights API specification, you can xref:tut-implement-am-flights.adoc[implement] the specification within an xref:tut-integrate-am-flights.adoc[integration].
