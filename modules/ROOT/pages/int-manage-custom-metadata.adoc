...
These metadata types are supported in Anypoint Code Builder:
...
. xref:int-configure-dw-expressions.adoc#set-custom-metadata-on-metadata-or-data-tab[Set Custom Metadata on the Metadata or Data Tab]
