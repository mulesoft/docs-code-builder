...
A *Loading...* error in the UI can occur when:
...
If the canvas UI does not open (the load state image keeps showing) after importing an existing project, it may be caused by a missing dependency. Follow these steps:
