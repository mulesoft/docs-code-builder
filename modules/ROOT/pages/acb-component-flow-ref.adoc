...
Anypoint Code Builder will open the target flow in the appropriate canvas:
...
This functionality helps you quickly trace and manage flow logic across modular designs, whether you're building or testing your application.
