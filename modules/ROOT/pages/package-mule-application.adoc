...
Package a Mule application without libraries from the `/lib` directory. To deploy this package successfully at runtime, you must provide dependencies declared in your project, which are not downloaded to the package at runtime. 
