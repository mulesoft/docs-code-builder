...
Package a Mule application without sources. For this lightweight package to deploy successfully at runtime, you must provide dependencies declared in the `pom.xml` file. Otherwise, the deployment will not run. 
