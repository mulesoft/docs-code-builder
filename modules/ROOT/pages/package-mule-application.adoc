...
Export your the source files from your project into a light JAR file that you can share. Others can import the source files into their Anypoint Code Builder IDE.
