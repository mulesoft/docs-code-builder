...
Package a Mule application in a JAR file.

== Package a Project in a Sharable JAR File

Export your the source files from your project to a light ZIP file that you can share with anyone to open and run your application in their IDE.
