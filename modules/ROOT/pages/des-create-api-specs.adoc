...
. Open the output panel to track the progress of internal processing as you design your API.
+
...
====
. In the `my-project-name` file, add your first resource. For example:
+
...
In the `my-project-name` file, add query parameters to a method. For example:
...
In the `my-project-name` file, add nested resources and methods. For example:
