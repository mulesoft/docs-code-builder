...
The error `Failed to authenticate to git remote` occurs: 

* If you select a different cloud region (EU Cloud or US Cloud) from the desktop IDE than your API specification project needs to synchronize your project in the Design Center SCM
+
To address this issue, ensure that your IDE is set to the correct region for your project. 

//* TODO: hanna reported another way this occurs