...
|===
+
Anypoint Code Builder also creates a separate `<graphql-router:data-fetcher>` trigger for each of your Mule flows. See xref:apikit::apikit-graphql-api-mapping.adoc[] for more information about data fetchers.
