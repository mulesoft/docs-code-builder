...
The `<graphql-router:data-fetcher>` element serves as a trigger for af flow. See xref:apikit::apikit-graphql-api-mapping.adoc[] for more information about data fetchers.
