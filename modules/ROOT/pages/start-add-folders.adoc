...
* Cloud IDE: `/home/_your-anypoint-user-name_` 
+
`your-anypoint-user-name` is the username you use to log into Anypoint Platform.
* Desktop IDE: Your operating system's home directory.
+
Examples: `_/Users/your-mac-user-name_` (Mac), `c:\Users\your-windows-user-name_` (Windows)
