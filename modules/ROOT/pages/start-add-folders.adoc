...
Default home directories are your top-level user folders: 

* Cloud IDE: `/home/your-anypoint-platform-username`
* Desktop IDE: Your operating system's home directory
+
Examples: `/Users/your-mac-username` (Mac), `c:\Users&#92;your-windows-username` (Windows)
