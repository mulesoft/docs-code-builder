...
* *Asset Name*
+
The name that Exchange uses to identify the published project.
* *Version*
+
The version number to be displayed in the *Version* section of the page that Exchange creates for the asset.
+
...
* *Description*
+
An optional description of your asset.
* *Business Group*
+
The business unit in Anypoint Platform to which the asset belongs.
* *Group ID*
+
The ID of the business unit in Anypoint Platform to which the asset belongs.
* *Artifact ID*
+
A unique ID that Exchange uses to identify the published asset. You should use the default value unless there is a published asset with the same ID.
. In *Advanced Options*, ensure that the following fields contain the correct values for your asset:
+
* *Tags*
+
The descriptors that Exchange uses to search for assets.
* *Categories*
+
The category that was previously added to Exchange. Refer to the xref:exchange::to-manage-categories.adoc[Manage Categories] documentation to learn how to create Categories for your organization.
