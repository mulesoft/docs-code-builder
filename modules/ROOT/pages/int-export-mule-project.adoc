...
* *Asset Name*
+
The name that Anypoint Exchange uses to identify the published project.
* *Version*
+
The version number to be displayed in the *Version* section of the page that Anypoint Exchange creates for the asset.
+
...
* *Artifact ID*
+
A unique ID that Anypoint Exchange uses to identify the published asset. You should use the default value unless there is a published asset with the same ID.
. In *Advanced Options*, ensure that the following fields contain the correct values for your asset:
+
* *Tags*
+
The descriptors that Anypoint Exchange uses to search for assets.
* *Categories*
+
The category that was previously added to Anypoint Exchange. Refer to the xref:exchange::to-manage-categories.adoc[Manage Categories] documentation to learn how to create Categories for your organization.
...
Once you select *Publish*, the publication of your project as a new asset in Exchange begins. You can follow the progress of this publication process in the *Terminal* view.
