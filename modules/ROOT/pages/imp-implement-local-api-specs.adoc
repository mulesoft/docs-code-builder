...
Implementing the API in this way enables you to reflect your changes to your API design directly into the interface in your Mule project.
...
When you are ready, you can then publish your API specification to Exchange and deploy your Mule project.

== Overview of the Scaffolding Process

When you scaffold an API, Anypoint Code Builder creates a _multi-root workspace_ in VS Code with both the API specification and integration project and keeps them synchronized.
...
For your projects to work properly, this file _must not reside_ within either project folder.
...
The procedures for creating the specification and implementation projects are designed to meet these requirements.
For information in the VS Code documentation, see https://code.visualstudio.com/docs/editor/multi-root-workspaces[Multi-root Workspaces^].
