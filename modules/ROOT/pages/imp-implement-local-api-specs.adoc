...
Anypoint Code Builder scaffolds your current local API specification into a new Mule project.

Both the API spec and the Mule project open in your IDE and you can work on both in the Explorer view.
