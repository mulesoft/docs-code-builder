...
[calloutlist]
. *Activity Bar*: Find a project from the *Explorer*. Use *Source Control* to store your project files, *Run and Debug* for integrations and implementations, *Extensions* for installations and updates in the desktop IDE, and *Manage* for a variety of management options.
+
...
[[use-autocomplete]]
== Use IntelliSense to Auto-Complete in the Editor

Anypoint Code Builder uses IntelliSense, a built-in code-completion feature of VS Code, 
to provide auto-completion in the Editor view.
