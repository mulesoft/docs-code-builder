...
* Using the extensions: Place your cursor at the location where you intend to use the auto-suggestion menu, and optionally, start typing to narrow the list of suggested options to return. If the line has some content, click Tab or provide a space after the content on the line. To close the auto-suggestion menu, click Escape. 
+
