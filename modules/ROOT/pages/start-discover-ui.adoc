...
* Using the extensions: Start typing in the editor to display a list of available options. Typing narrows the list of options.
+
For API design, auto-completion must be enabled.
+
.Show me how
[%collapsible]
====
