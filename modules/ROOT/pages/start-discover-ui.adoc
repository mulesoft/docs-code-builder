...
. *Output Panel*: As your projects run in Anypoint Code Builder, view output and logs in *Mule DX Server*. Open the built-in command terminal. View problems and ports.
