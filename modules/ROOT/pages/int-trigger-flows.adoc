...
//next steps:
. In the terminal, click the name of the shell to use in the terminal, such as PowerShell (Windows), `bash`, or `zsh` (Mac). 
+
...
+
----
$ curl localhost:8081/api/myendpoint
----
...
. Find and copy the URL to your app:
+
