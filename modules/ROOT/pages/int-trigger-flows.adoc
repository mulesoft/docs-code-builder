...
----
+
In this case, the endpoint is defined with the `name` attribute of the `<flow/>` element. For example, assume that a flow in a scaffolded interface references a flow (`getFlights`):
+
[source,xml]
----
