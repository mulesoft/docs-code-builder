...
When an integration or implementation that you are developing builds successfully, the application deploys locally within your development environment in Anypoint Code Builder, whether you are using the desktop or cloud IDE. 
