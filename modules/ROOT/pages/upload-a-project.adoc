...
:open-root: If you do not open the root directory, the project does not load correctly because Visual Studio Code does not recognize the directory as a workspace. The applications does not display the UI canvas for the application.
...
Import and unpack a project JAR file into a workspace.
...
Import and unpack a project JAR file for a project:
...
. After the process upload process is complete, provide the following command to import the JAR file to your workspace:
+
[source,command]
----
MuleSoft: Import a Project
...
. Navigate to your the _root_ of the project folder, using the following command to open the folder:
+
[source,command]
----
 File: Open Folder...
----
+
When you open the root folder, the web IDE opens your project in a workspace.
+
+
// see text for this variable defined under title
{open-root}
