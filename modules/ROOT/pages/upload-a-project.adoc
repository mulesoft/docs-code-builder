...
Import a project JAR file or folder into a workspace in your IDE. A project directory contains a Mule application for an implementation or integration, or contains an API specification. 
