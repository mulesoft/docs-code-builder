...
To _export_ a JAR file that packages a project with your application, see xref:package-mule-application.adoc[].
...
Import a JAR file to automatically unpack its contents to a project folder.
