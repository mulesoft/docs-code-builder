...
include::partial$acb-open-packaged-sources.adoc[tags="close-folder"]
...
. Select an Anypoint Code Builder directory, such as your home directory:
+
...
+
image::file-open-folder-command.png[]
. Select your Anypoint Code Builder home directory or subdirectory of your choice:
+
image::select-home-directory.png[]
