...
:open-root: If you do not open the root directory, the project does not load correctly because Visual Studio Code does not recognize the directory as a workspace. A Mule application does not load the UI canvas for the application.
