...
* Credentials (client ID and secret) that enable the Mule runtime instance in your Mule app to access the business group on Anypoint Platform that hosts your Mule Gateway proxy 
+
The credentials are available from Access Management, on Anypoint Platform.

To acquire and configure the ID and credentials in a Mule app, see <<setup>>.
