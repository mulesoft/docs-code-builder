...
For other important uses of Mule Gateway API instances, review xref:api-manager::api-instance-landing-page.adoc[] and xref:mule-gateway::manage-policies-overview.adoc[].
