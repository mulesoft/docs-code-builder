...
+
You can insert the code that was generated into your flow, or you can copy the code snippet and use it elsewhere. 
...
+
. Enter the prompt to create the initial flow for your task and click the send icon image:int-send-prompt.png["",15,15].
+
