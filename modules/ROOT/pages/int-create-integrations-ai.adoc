...
The Generative Flow feature transforms your natural language prompt, which describes your business logic, into a flow that contains the connectors and processors, in the order needed, to accomplish the specified task. 
...
Before you create a flow, define what you want achieve with the flow, for example, optimizing a business process. Craft your prompt using natural language, and keep in mind that the more concise and specific you make your prompt, the more effective Einstein is when generating your flow. 
...
* The generated response to your prompt will always be unique, depending on the wording you use and which LLM libraries are used. 
====
...
. After you inspect the code for your generated flow, click the Insert icon. 
+
