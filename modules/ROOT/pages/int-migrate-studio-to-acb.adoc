...
//TODO: Complete this section. Include "How to add configs" in this section if appropriate.
...
// TODO: If possible, provide only one option for importing the project. Let's choose the happy path.
...
If the IDE shows the *Mule runtime or Java version requires further action* error, this means that the Mule runtime or Java version in the project is not compatible with the IDE.
