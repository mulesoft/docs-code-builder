...
:page-aliases: tut-api-publish-api-spec-to-exchange.adoc
...
Publish your API specification to Exchange so that other team members can find and implement it.
...
+
set-asset-name.png["American Flights API option highlighted"]
...
. Select *No* when prompted to implement the API to avoid scaffolding the American Flights API specification into your integration yet.
+
