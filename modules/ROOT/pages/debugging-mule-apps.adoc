...
** In the cloud IDE, select *File* > *View* > *Run*.
====
. In the *Run and Debug* pane, click the image:icon-start-debug.png["",15,15] (*Start Debugging (F5)*) icon for *Debug Mule Application*.
+
--
...
To stop your debug session, in the *Run and Debug* pane, click the image:icon-stop.png["",15,15] (*Stop*) icon. 
