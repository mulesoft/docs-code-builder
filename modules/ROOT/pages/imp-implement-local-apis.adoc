...
--
. When prompted, provide a name for your Mule project.
. Navigate to a folder for your Mule project, and click *Select target folder*.  
. When prompted, select a Mule runtime version for the project.
. When prompted, select a JDK version for the project.
+
