= Creating API Specs and Fragments with AI
...
== Design an API Spec or Fragment with AI

To design an API spec or fragment with AI, begin by reviewing the starter prompt for guidance on the context the agent needs. 

. Describe your API spec or fragment in the chat by using natural language. The agent prompts you for clarification if it doesn't understand your request.
+
...
. Click *Replace* to add the generated API spec or fragment to your project. All file content is replaced by the inserted code.
+
You can also copy the generated API spec or fragment to your clipboard by clicking *Copy*.
...
You can only create a new API spec or fragment if you have a project open. Click *Create API Spec* from the *New Chat* dropdown to create a new API spec. 
