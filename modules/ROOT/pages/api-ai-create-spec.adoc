...
== Design an API with AI

To design an API with AI, begin by reviewing the starter prompt for guidance on the context the agent needs. 

. Describe your API spec in the chat by using natural language. The agent prompts you for clarification if it doesn't understand your request and asks for any required details it needs if you don't provide them.
+
...
. Add the generated API spec to your project, click *Replace*. All file content is replaced by the inserted code. You can also copy the generated API spec to your clipboard by clicking *Copy*.
...
You can only create a new API spec or API fragment if you have a project open. Click *Create API Spec* from the *New Chat* dropdown to create a new spec.
