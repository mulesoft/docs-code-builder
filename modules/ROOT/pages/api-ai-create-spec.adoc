...
The AI-powered API Specification feature enables you to generate and mock API specifications from natural language prompts. This feature reduces the time spent on API design by simplifying the creation of syntax-heavy specifications. Dev Agent powers these capabilities through the embedded MCP client in Anypoint Code Builder.
...
. Click *Replace* to insert the generated API spec into your project. All file content is replaced by the generated code.
+
