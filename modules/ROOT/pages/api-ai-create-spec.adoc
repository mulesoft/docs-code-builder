...
You can only create a new API spec if you have a project open and that's in the supported RAML 1.0 or OAS 3.0 format. Click *Create API Spec* from the *New Chat* dropdown to create a new API spec.
