= Publishing American Flights API to Anypoint Exchange
...
+
Selecting *Yes* scaffolds the API specification into your project. Instead of scaffolding now, you will scaffold in xref:tut-implement-am-flights-api.adoc[].
...
Start an integration app for American Flights: xref:tut-integrate-am-flights.adoc[]
