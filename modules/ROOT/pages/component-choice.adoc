...
:page-aliases: acb-component-choice.adoc
:version: 4.x
...
include::anypoint-code-builder::partial$mule-components/{version}/component-{component-filename}.adoc[tag=adding-routes]
// 
//EXAMPLES SECTION
