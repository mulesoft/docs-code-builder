...
// TODO: batch is only in Mule docs right now
* xref:mule-runtime::batch-processing-concept.adoc[Batch (<batch:/>)]
...
//* xref:component-batch.adoc[]
//does this even make sense here? 
//* xref:component-scheduler-pools.adoc[] 
//
