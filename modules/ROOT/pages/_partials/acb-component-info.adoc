...
* xref:agentforce-connector::index.adoc[Agentforce Connector] (Agentforce Connector)
...
* xref:einstein-ai-connector::index.adoc[Einstein AI Connector] (Einstein AI Connector)
