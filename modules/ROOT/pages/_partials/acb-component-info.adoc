...
The following example illustrates basic configurations for adding components to your project from the canvas and the code editor. The example assumes you are beginning with an empty integration project.
