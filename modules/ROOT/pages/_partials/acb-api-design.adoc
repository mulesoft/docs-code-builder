...
. Open the *Extensions* panel from the activity bar.
. Right-click the extension *Anypoint Code Builder - API Extension* and click *Extensions Settings*.
. Enable Mule editor auto-completion options. 
