...
Due to parser limitations, the recommendation for the total project size (all files in your design project) is less than 500 KB.
...
* Include concise and short examples: 
+
----
Book:
  type: string
...
* When extracting RAML fragments, import the fragments as local declaration first.
