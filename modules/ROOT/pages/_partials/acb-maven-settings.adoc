...
//
// tag::add-plugin-repo-settings[]
Add the following `pluginRepository` setting _within_ `<profile><pluginRepositories></pluginRepositories></profile>`:
+
[source,xml]
----
<pluginRepository>
