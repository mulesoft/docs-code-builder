...
+
NOTE::
If an Anypoint Platform session is active in any of your browsers when you install Anypoint Extension Pack, the extension pack uses that session to log you in to Anypoint Platform from the IDE. You can log out and log in to the IDE at any time. 
