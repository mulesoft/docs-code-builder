...
. Recommended: Ensure that the extensions update automatically by right-clicking each Anypoint Code Builder extension and selecting *Auto Update*, for example:
+
