...
.. Stage your files to your local repository by mousing over the *Changes* area (located after the *Commit* button) and clicking the image:anypoint-code-builder::icon-scm-add-changes.png["",15,15] (plus) icon.
+
image::aypoint-code-builderstart-scm-repo-stage-changes.png["Adding commit message for staged changes"]
+
