...
* In the cloud IDE, click the image:anypoint-code-builder::icon-menu.png["",18,18] (menu), and select *View* > *Command Palette*.
====
...
[%collapsible]
====
** Click image:icon-run-debug.png["",15,15] (*Run and Debug*) in the activity bar.
** Use the keyboard shortcuts:
+
*** Mac: Cmd+Shift+d
*** Windows: Ctrl+Shift+d
** In the desktop IDE, select *View* > *Run*.
** In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *View* > *Run*.
====
// end::open-run-debug[]
//
...
* In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *View* > *Output*.
====
...
[%collapsible]
====
Click image:icon-source-control.png["",15,15] (*Source Control*) in the activity bar or use the keyboard shortcuts:
...
[%collapsible]
====
Click image:icon-source-control-no-edits.png["",15,15] (*Source Control*) in the activity bar or use the keyboard shortcuts:
...
* In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *Preferences* > *Configure User Snippets*.
* In either IDE:
...
// tag::open-ide[]
// Open the ACB IDE
. In the activity bar of the IDE, click image:icon-ms-logo.png["",20,20] (*Anypoint Code Builder*).
// end::open-ide[]
//
//
// tag::close-project[]
...
* In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *File* > *Close Folder*.
====
// end::close-project[]
//
//
...
image:icon-api-console.png["",14,14] (*API Console*) to open the fragment in the console.
+
...
//
// tag::deploy-locally[]
. Click image:icon-start-debug.png["",15,15] (*Start Debugging (F5)*) for *Debug Mule Application*.
+
...
* In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *Terminal* > *New Terminal*.
...
.. Stage your files to your local repository by hovering over the *Changes* area (located after the *Commit* button) and clicking the image:anypoint-code-builder::icon-scm-add-changes.png["",15,15] (plus).
+
