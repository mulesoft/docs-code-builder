...
+
//TODO: pom.xml or JSON file?
You can also open your new project's `pom.xml` from the Explorer to check the Mule and Java versions, for example:
+
include::anypoint-code-builder::partial$acb-reusable-steps.adoc[tag=pom-mule-java-ex]
+
