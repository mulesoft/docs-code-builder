...
** In the cloud IDE, click the image:icon-menu.png["cloud IDE menu",18,18] (menu) icon, and select *View* > *Run*.
====
// end::open-run-debug[]
//
...
* In the cloud IDE, click the image:icon-menu.png["cloud IDE menu",18,18] (menu) icon, and select *Preferences* > *Configure User Snippets*.
* In either IDE:
...
* In the cloud IDE, click the image:icon-menu.png["cloud IDE menu",18,18] (menu) icon, and select *Terminal* > *New Terminal*.
