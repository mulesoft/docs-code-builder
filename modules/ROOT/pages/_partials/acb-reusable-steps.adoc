...
.. Stage your files to your local repository by hovering over the *Changes* area (located after the *Commit* button) and clicking image:anypoint-code-builder::icon-scm-add-changes.png["",15,15] (plus).
+
