...
* From the cloud IDE, click the image:anypoint-code-builder::icon-menu.png["",15,15] (menu) icon, and select *View* > *Command Palette*.
====
...
* From the cloud IDE, click the image:anypoint-code-builder::icon-menu.png["",15,15] (menu) icon, and select *File* > *Close Folder*.
====
// end::close-project[]
//
//
...
* From the cloud IDE: Navigate to the image:anypoint-code-builder::icon-menu.png["",15,15] (menu) icon > *Terminal* > *New Terminal*.
