...
Anypoint Code Builder does not support scaffolding API specs that incorporate OAS or JSON schema fragments that you import from Exchange as project dependencies.
