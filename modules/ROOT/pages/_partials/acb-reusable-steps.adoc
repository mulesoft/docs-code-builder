...
.. Navigate to a directory for your project, and click .
.. Select a Mule runtime (Mule) version for your project.
.. Select a supported JDK for Mule.
...
+
You can also open your new project's `pom.xml` from the Explorer to check the Mule and JDK versions, for example:
+
include::anypoint-code-builder::partial$acb-reusable-steps.adoc[tag=pom-mule-jdk-ex]
+
The `pom.xml` is located at the root level of the project directory. 
====
...
<properties>
  ...
  <mule.runtime.version>4.4.0-20231211</mule.runtime.version>
  <mule.jdk.version>11.0.19_7</mule.jdk.version>
</properties>
--
// end::pom-mule-jdk-ex[]
//
...
//for Mule and Java/JDK versions in Settings tab:
