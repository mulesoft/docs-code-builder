...
* Anypoint Platform requires a user account. You can use an existing account or create one from Anypoint Platform in the US or EU cloud (see xref:index.adoc#us-eu-clouds[US and EU Cloud Hosts]).
