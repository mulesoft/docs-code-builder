...
* Click image:icon-menu.png["",18,18] (menu), and select *View* > *Command Palette*.
====
...
// * From the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *View* > *Command Palette*.
====
...
* In the cloud IDE, click image:icon-menu.png["",18,18] (menu), and select *View* > *Command Palette*.
====
.. Provide this command:
+
[source,command]
