...
* From the cloud IDE, click the image:icon-menu.png["cloud IDE menu",24,20] (menu) icon, and select *File* > *Close Folder*.
====
+
...
* Click the image:icon-menu.png["cloud IDE menu",24,20] (menu) icon, and select *View* > *Command Palette*.
====
...
* From the cloud IDE, click the image:icon-menu.png["cloud IDE menu",24,20] (menu) icon, and select *View* > *Output*.
...
// * From the cloud IDE, click the image:icon-menu.png["cloud IDE menu",24,20] (menu) icon, and select *View* > *Command Palette*.
====
.. Select the following command:
+
[source,command]
