...
Projects open instantly using bundled runtimes. The IDE provides a notification only if you must download a specific Mule runtime or Java version for running or debugging your application. Mule runtime downloads to `${user.home}/AnypointCodeBuilder/runtimes`, and the selected Java version downloads to `${user.home}/AnypointCodeBuilder/java`.
