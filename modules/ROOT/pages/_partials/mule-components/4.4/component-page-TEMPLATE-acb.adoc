...
//
// see global config example in Cache component docs
//component XML global config
//include::anypoint-code-builder::partial$mule-components/4.x/component-{component-filename}.adoc[tag=component-xml-global-config]
//
