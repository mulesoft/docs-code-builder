...
The Subflow component works in a similar way to the xref:component-flow.adoc[Flow] component but with the following differences: 
...
//Use the xref:component-try.adoc[Try] scope within a subflow to perform error handling.
