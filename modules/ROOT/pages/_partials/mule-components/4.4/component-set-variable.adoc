...
Don't use Set Variable for complex expressions or transformations, instead use it for simple operations, such as selections, and use the xref:transform-component-about.adoc[Transform Component] for complex scenarios.
