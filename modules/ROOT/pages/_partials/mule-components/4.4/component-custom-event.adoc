...
Custom Business Event (`<tracking:custom-event/>`) provides attributes in the configuration UI and XML:
...
The child element `<tracking:meta-data/>` provides attributes in the configuration UI and XML:
