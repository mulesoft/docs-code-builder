...
//This behavior enables you to dynamically select the script, instead of hardcoding it into the xref:component-transform.adoc[Transform Message component].
