...
Write a xref:2.4@dataweave::dataweave-language-introduction.adoc[DataWeave script] within a Transform component (`<ee:transform/>`) to create or transform content for any parts of the xref:mule-runtime::about-mule-event.adoc[Mule event]:
...
* xref:dataweave::dataweave-language-guide.adoc[DataWeave Language]
