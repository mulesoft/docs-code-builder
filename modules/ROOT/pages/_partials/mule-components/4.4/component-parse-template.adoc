...
| `target`
| Name of the variable where the result of the expression defined in `targetValue` is stored after Parse Template executes. For more information, see xref:mule-runtime::target-variables.adoc[].
