...
Configure a template through an external file reference or you can embed the template in the component definition.
...
| `target`
| Name of the variable where the result of the expression defined in `targetValue` is stored after Parse Template executes.
