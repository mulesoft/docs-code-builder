...
| `target`
| 
include::partial$component-info.adoc[tag=target-variable]
include::partial$component-info.adoc[tag=xref-target-variables]

| *Target Value*
| `targetValue`
| 
include::partial$component-info.adoc[tag=target-variable-value]
include::partial$component-info.adoc[tag=xref-target-variables]
