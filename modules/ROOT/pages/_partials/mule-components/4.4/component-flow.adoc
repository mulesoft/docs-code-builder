...
The Flow component is fundamental to a Mule application. Because all Mule apps must contain at least one flow, Anypoint Code Builder automatically provide the first Flow component in your Mule app. You can create additional flows in your Mule app. 
