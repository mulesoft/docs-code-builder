...
| Flow automatically created by the APIkit module if you import or design an API specification. These flows map incoming API requests to the appropriate logic and responses. Each action in the API specification results in a flow.
|===
