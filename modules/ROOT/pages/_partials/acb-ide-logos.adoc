...
[%header,cols="1"]
|===
|image:logo-ACBweb-active.png["Web IDE for Anypoint Code Builder"] 
 image:logo-ACBdesktop-disabled.png["Desktop IDE for Anypoint Code Builder"] 
 Web IDE info only
|===
...
[%header,cols="1"]
|===
|image:logo-ACBweb-disabled.png[Web IDE for Anypoint Code Builder] 
 image:logo-ACBdesktop-active.png[Desktop IDE for Anypoint Code Builder] 
