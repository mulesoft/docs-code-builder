...
The generated application includes the flows, connector configurations, a sample properties file, and the dependencies required for connectors such as Salesforce and HTTP. These artifacts ensure that the generated integration is runnable and can be deployed directly from Anypoint Code Builder.
