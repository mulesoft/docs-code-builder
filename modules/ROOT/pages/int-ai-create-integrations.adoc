...
To use connectors, click *Connect to an agent* or *Create an MCP server* in the *Build Agent-Enabled Apps* card. To use the MCP Connector (beta), set Design Service: System Properties and Default Arguments in xref:ref-mule-settings.adoc[].
