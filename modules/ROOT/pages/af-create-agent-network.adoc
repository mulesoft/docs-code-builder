...
MuleSoft Dev Agent can help you create your project. Click the agent icon image:af-acb-dev-agent-icon.png["",18,18] in the Anypoint Code Builder activity bar. Describe your agent network, including the brokers, agents, MCP servers, and LLMs you want to connect. MuleSoft Dev Agent does the rest. For more information about MuleSoft Dev Agent, see xref:api-ai-create-spec.adoc[].
