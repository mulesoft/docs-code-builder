...
+
images::acb-project-directory.png["project direction in a Mule app"]
...
+
.Example that encrypts `"mysensitivevalue"` using Blowfish and the value `my-key` as a password for the encryption key:
[source,terminal]
----
