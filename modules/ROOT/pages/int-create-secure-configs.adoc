...
. When prompted, enter a value of your choice for the encryption key.
//TODO: ADD SCREENSHOT
. Select an environment for your deployment (*Sandbox* or *Design*).
+
Deployments directly to the Production environment are not allowed. 
+ 
