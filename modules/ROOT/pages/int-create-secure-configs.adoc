...
* Easily select settings, such as different hosts, ports, and directory paths, for a specific deployment environment (development, sandbox, production, or another environment). 
