...
MuleSoft Secure Properties Tool accepts the following algorithms:
...
MuleSoft Secure Properties Tool accepts the following ciphers:
...
For your reference, examples in the procedure are based on these configurations:
...
+
If you want to use the variable `$\{env}` in your filename configuration, see <<prop-files>> for guidance.
