...
If your application uses encrypted properties, add arguments for the encryption key and value to the runtime command in your IDE. This setting enables the runtime to decrypt properties used in your the application when the application deploys in your IDE and deploy successfully.
