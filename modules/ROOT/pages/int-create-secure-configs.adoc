...
.. If your application defines encrypted properties in your properties file, configure the *Runtime: Default Arguments* command in the IDE with the encryption key and value. 
+
See <<test-deploy>> for guidance.
