...
----
+
Important: Be sure to store your encryption key value (password) in a safe place that you can retrieve when you deploy your application.
+
.Encrypted Output:
[source,terminal]
----
...
+
This name serves as the key for the encryption value (password) used to encrypt your secure properties with the Secure Properties Tools.
...
If your application uses encrypted properties, add arguments for the encryption key and value to the runtime command in your IDE. This setting enables the runtime to decrypt properties used in your application when the application deploys in your IDE and deploy successfully.
...
+
This procedure shows how to hide the hidden encryption key value in Runtime Manager. 
