...
Encrypt sensitive values of properties used in your Mule applications, and hide the name of the decryption key in Runtime Manager when the application deploys to CloudHub. 
