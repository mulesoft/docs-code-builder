...
To provide property settings for different environments, such as production and development environments, you can use a variable in the file name instead of hard-coding the entire name. See <<create-prop-file>>.
