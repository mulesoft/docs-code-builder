...
+
When the project is ready for editing, the API project and API specification file opens in the IDE.

To create a working API specification that you can implement within an integration, see xref:design-api-specification-from-scratch.adoc[].