...
The desktop and cloud IDEs offer the same Anypoint Code Builder functionality, so use an IDE that works better for your needs. You can share projects between IDEs or with members of your team by using project import and export features.
