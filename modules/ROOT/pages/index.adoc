...
Get the Anypoint Code Builder experience through the Anypoint Extension Pack for Visual Studio Code. The web-based extensions are built into code-server, a web-based IDE based on VS Code. The desktop extensions require installation to your VS Code IDE. See xref:setup.adoc[].
