...
The desktop and cloud IDEs offer the same Anypoint Code Builder functionality, so you can choose an IDE that works better for your needs, or use both. Projects are not shared between IDEs. 
