...
* Canada cloud (desktop IDE only): https://ca1.platform.mulesoft.com/login/[ca1.platform.mulesoft.com^]
+
MuleSoft hosts this control plane within Canada (North America) data centers.

* Japan cloud (desktop IDE only): https://jp1.platform.mulesoft.com/login/[jp1.platform.mulesoft.com^]
+
MuleSoft hosts this control plane within Japan (APAC) data centers.

* India cloud (desktop IDE only): https://in1.platform.mulesoft.com/login/[in1.platform.mulesoft.com^]
+
